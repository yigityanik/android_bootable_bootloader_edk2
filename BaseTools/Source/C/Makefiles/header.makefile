...
CFLAGS = -MD -fshort-wchar -fno-strict-aliasing -Wall -Wno-error -Wno-deprecated-declarations -Wno-shift-negative-value -Wno-self-assign -nostdlib -c -g
else
CFLAGS = -MD -fshort-wchar -fno-strict-aliasing -Wall -Wno-error -Wno-deprecated-declarations -Wno-shift-negative-value -nostdlib -c -g
endif
LFLAGS =
